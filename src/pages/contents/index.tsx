...
export function ContentListPage(props: ContentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getContents({
        relations: ['user', 'recommendation.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['type.contains', 'title.contains', 'description.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('recommendation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.recommendation,
        }
      : null,
